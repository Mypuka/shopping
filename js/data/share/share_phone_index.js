    ...
    for(var i=0;i<data.length;i++){
        (function  a(){
                ...
                var html=`
					 <li class="fl">
		                <div class="goods_img">
		                    <a href="javascript:" onclick="top.location.href='../detail_html/all/women_${i}.html'" class="block">
    ...
    // onclick="window.open('../detail_html/all/women_${i}.html')"//另打开一页面
    // onclick="top.location.href='../detail_html/all/women_${i}.html'"
    /**************************************************/
