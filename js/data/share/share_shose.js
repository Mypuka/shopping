    ...
    for(var i=0;i<shoes_data.length;i++){
        (function  a(){
                ...
                var html=`
					 <li class="fl">
		                <div class="goods_img">
		                    <a href="javascript:" onclick="top.location.href='../detail_html/shose/women_${i}.html'" class="block">
		                        <img src="../img/all_img/${json.imgUrl}"/>
		                    </a>
		                </div>
		                <p class="goods_name over">
		                    <a onclick="top.location.href='../detail_html/shose/women_${i}.html'" class="block">
		                        ${json.title}
		                    </a>
		                </p>
		                <p class="price">
